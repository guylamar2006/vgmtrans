...
class WhitakerSnesScanner : public VGMScanner {
 public:
  explicit WhitakerSnesScanner(Format* format) : VGMScanner(format) {}

  virtual void scan(RawFile *file, void *info = 0);
  void searchForWhitakerSnesFromARAM(RawFile *file);
