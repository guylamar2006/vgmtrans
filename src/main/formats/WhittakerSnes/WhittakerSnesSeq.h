...
class WhittakerSnesSeq
    : public VGMSeq {
 public:
  WhittakerSnesSeq(RawFile *file, WhittakerSnesVersion ver, uint32_t seqdata_offset, std::string newName = "Rare SNES Seq");
...
class WhittakerSnesTrack
    : public SeqTrack {
 public:
  WhittakerSnesTrack(WhittakerSnesSeq *parentFile, uint32_t offset = 0, uint32_t length = 0);
  virtual void resetVars();
